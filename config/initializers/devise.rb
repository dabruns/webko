...
Devise.setup do |config|
  ...
  # reset. Defaults to true, so a user
  ...
  # You can use
  # :sha1, :sha512 or encryptors from others
  # authentication tools as :clearance_sha1,
  # :authlogic_sha512 (then you should set stretches
  # above to 20 for default behavior)
  # and :restful_authentication_sha1
  # (then you should set stretches to 10, and copy
